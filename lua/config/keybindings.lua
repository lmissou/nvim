...
function M.setup()
  ...
  -- M.bind_key({ 'n', 'v', 'i' }, '<C-M-h>', '<C-w><', 'Increace window size(horizontal)')
  -- M.bind_key({ 'n', 'v', 'i' }, '<C-M-l>', '<C-w>>', 'Decreace window size(horizontal)')
  -- M.bind_key({ 'n', 'v', 'i' }, '<C-M-j>', '<C-w>+', 'Increace window size(vertical)')
  -- M.bind_key({ 'n', 'v', 'i' }, '<C-M-k>', '<C-w>-', 'Decreace window size(vertical)')
  -- Buffer切换
